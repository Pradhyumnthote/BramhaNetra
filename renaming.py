...
# Path to the main folder containing the subfolders to be renamed
main_folder_path = '/home/dai/Desktop/BramhaNetra/SET1'

# Iterate over each subfolder and rename them
for folder_name in os.listdir(main_folder_path):
    new_folder_name = folder_name
    for hindi_char, english_char in zip(hindi_characters, english_transliterations):
        new_folder_name = new_folder_name.replace(hindi_char.strip(), english_char)
    os.rename(os.path.join(main_folder_path, folder_name), os.path.join(main_folder_path, new_folder_name))